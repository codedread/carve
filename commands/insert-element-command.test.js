...
describe('InsertElementCommand tests', () => {
    ...
    describe('Insert new element', () => {
        ...
        beforeEach(() => {
            ...
            cmd = new InsertElementCommand(fakeElem);
        });
    ...
    describe('Insert element into a new position', () => {
        ...
        beforeEach(() => {
            ...
            cmd = new InsertElementCommand(fakeElem, fakeNewParent, fakeNewNextSibling);
        });
...
//# sourceMappingURL=insert-element-command.test.js.map