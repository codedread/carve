...
import { DEFAULT_DRAWING_STYLE, DRAWING_STYLE_CHANGED_EVENT_TYPE } from '../drawing-style.js';
...
export class PaintFillTool extends SimpleActionTool {
    ...
    getActions() { return [ACTION_PAINT_FILL]; }
    /**
...
export class PaintFillButton extends ToolbarButton {
    fillColor = DEFAULT_DRAWING_STYLE.fill;
    constructor(tool) {
        super(tool);
        tool.getHost().addEventListener(DRAWING_STYLE_CHANGED_EVENT_TYPE, (evt) => {
            this.fillColor = evt.drawingStyle.fill;
            this.render();
        });
    }
    getAction() { return ACTION_PAINT_FILL; }
    getButtonDOM() {
...
//# sourceMappingURL=paint-fill.js.map