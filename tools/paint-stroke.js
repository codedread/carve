...
export class PaintStrokeTool extends SimpleActionTool {
    ...
    getActions() { return [ACTION_PAINT_STROKE]; }
    /**
...
export class PaintStrokeButton extends ToolbarButton {
    strokeColor = DEFAULT_DRAWING_STYLE.stroke;
    constructor(tool) {
        super(tool);
        tool.getHost().addEventListener(DrawingStyleChangedEvent.TYPE, (evt) => {
            this.strokeColor = evt.newDrawingStyle.stroke;
            this.render();
        });
    }
    getAction() { return ACTION_PAINT_STROKE; }
    getButtonDOM() {
...
//# sourceMappingURL=paint-stroke.js.map